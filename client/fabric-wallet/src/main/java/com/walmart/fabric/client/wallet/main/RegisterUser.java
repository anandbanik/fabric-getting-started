...
public class RegisterUser {
	...
	public void generateWallet() throws Exception {
		...
		if (wallet.get("clientUser") != null) {
			logger.info("An identity for the user \"clientUser\" already exists in the wallet");
			return;
		}
		...
		Enrollment enrollment = caClient.enroll("clientUser", enrollmentSecret);
			...
			logger.error("Error: "+rex.getMessage());
		}
		...
		logger.info("Successfully enrolled user \"clientUser\" and imported it into the wallet");
	}
